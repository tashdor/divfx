...
These pages are **new material**, not part of v1.0.1. They are drafted to fill the gaps identified in [Notes for v1.1](../v1.1-notes.md#gaps) and are published here for review rather than folded into the chapters, so that what is original and what is new stays visible.
...
These follow the handbook's existing voice: practical guidance for independent productions, studio practice explained in terms of what it costs and what it prevents, and specifics named precisely enough to act on. Where a topic has an expert-level subtlety that working productions actually trip over, it is called out rather than smoothed away.
